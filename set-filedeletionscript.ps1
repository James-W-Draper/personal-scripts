...
$inputCsvPath = "C:\scripts\CHG0078128 - ukgs2file1.csv"  # Path to the input CSV file
...
foreach ($file in $fileList) {
    $filePath = Escape-SpecialCharacters -filePath $file.Path  # Escape special characters in the file path
